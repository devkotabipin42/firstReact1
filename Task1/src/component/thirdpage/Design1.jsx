...
const design1 = () => {
  return (
    <div className='flex gap- '>
      <img src="https://images.unsplash.com/photo-1718963892337-b6729c302b8f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className='h-[45vh] w-[100%] object-cover object-center rounded-2xl  p-2'/>
